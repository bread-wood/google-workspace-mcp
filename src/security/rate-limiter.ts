...
const DEFAULT_LIMITS: Record<string, RateLimitConfig> = {
  ...
  drive_create_pdf: { maxRequests: 10, windowMs: 60_000 },
  drive_create_folder: { maxRequests: 10, windowMs: 60_000 },
  drive_move: { maxRequests: 15, windowMs: 60_000 },
  ...
  gmail_create_filter: { maxRequests: 20, windowMs: 60_000 },
